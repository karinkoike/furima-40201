class OrderForm
  ...
  attr_accessor :post, :prefecture_id, :city, :block, :building_name, :phone_number, :user_id, :item_id, :token
  ...
  def save
    ...
    Order.transaction do
      ...
      ShippingAdress.create(post: post, prefecture_id: prefecture_id, city: city, block: block, building_name: building_name, phone_number: phone_number)
    end
